"""
Retry calls for rows 100-200 where transfer column is empty
"""
import sys
import os
...
# Configuration
START_ROW = 100  # Start from row 100 (0-indexed: 100-199)
END_ROW = 200    # End at row 200 (exclusive, so 100-199)
CALL_INTERVAL_SECONDS = 36  # 36 seconds between calls

if __name__ == "__main__":
    print("=" * 80)
    print("📞 RETRY CALLS FOR ROWS 100-200 WITH EMPTY TRANSFER STATUS")
    print("=" * 80)
    ...
    try:
        ...
        # Get all customers and filter to rows 100-200
        print("\n" + "=" * 80)
        print(f"🔍 FETCHING CUSTOMERS (ROWS {START_ROW}-{END_ROW-1})")
        print("=" * 80)
        all_customers = smartsheet_service.get_all_customers_with_stages()
        
        # Filter to rows 100-200 (0-indexed: 100-199)
        target_rows = all_customers[START_ROW:END_ROW]
